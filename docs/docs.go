...
const docTemplate = `{
        ...
        "/v1/keep/story": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "정렬 기준. 최신순=recent, 오래된순(디폴트)=old, 좋아요가 많은순=like",
                        "name": "filter",
                        "in": "query"
                    },
                    {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/handler.GetSubscribedKeepsResponse"
                                            }
                                        }
                                    }
                                }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/handler.GetSongsFromKeepInStoryResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/v1/record/{songRecordingId}/my": {
            "get": {
                ...
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/handler.GetDetailRecordingResponse"
                                        }
                                    }
                                }
                            ]
                    ...
                    "500": {
                        "description": "녹음 정보가 없는 경우\" \"error"
                    }
                }
            },
            "delete": {
    ...
    "definitions": {
        ...
        "handler.GetDetailRecordingResponse": {
            "type": "object",
            "properties": {
                "preSignedURL": {
                    "type": "string"
        ...
        "handler.GetSongsFromKeepInStoryResponse": {
            ...
            "properties": {
                ...
                "songs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handler.GetSongsFromKeepStories"
                    }
                }
            }
        },
        "handler.GetSongsFromKeepStories": {
            "type": "object",
            "properties": {
                "album": {
                    "type": "string"
        ...
        "handler.GetSubscribedKeepsResponse": {
            "type": "object",
            "properties": {
                "keepListId": {
                    "type": "integer"
