...
var (
	keepListAllColumns            = []string{"keep_list_id", "member_id", "keep_name"}
	keepListColumnsWithoutDefault = []string{"member_id", "keep_name"}
	keepListColumnsWithDefault    = []string{"keep_list_id"}
