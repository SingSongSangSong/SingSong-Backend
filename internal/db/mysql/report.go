...
var ReportWhere = struct {
	...
	CreatedAt:        whereHelpernull_Time{field: "`report`.`created_at`"},
	UpdatedAt:        whereHelpernull_Time{field: "`report`.`updated_at`"},
	DeletedAt:        whereHelpernull_Time{field: "`report`.`deleted_at`"},
}
...
var (
	reportAllColumns            = []string{"report_id", "comment_id", "reporter_member_id", "subject_member_id", "report_reason", "created_at", "updated_at", "deleted_at"}
	reportColumnsWithoutDefault = []string{"comment_id", "reporter_member_id", "subject_member_id", "report_reason", "deleted_at"}
	reportColumnsWithDefault    = []string{"report_id", "created_at", "updated_at"}
