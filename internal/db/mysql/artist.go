...
var (
	artistAllColumns            = []string{"artist_id", "artist_name", "artist_type", "related_artists", "country"}
	artistColumnsWithoutDefault = []string{"artist_name", "artist_type", "related_artists", "country"}
	artistColumnsWithDefault    = []string{"artist_id"}
