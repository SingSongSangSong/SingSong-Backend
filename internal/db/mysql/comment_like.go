...
type CommentLike struct {
	CommentLikeID int64     `boil:"comment_like_id" json:"comment_like_id" toml:"comment_like_id" yaml:"comment_like_id"`
...
var CommentLikeTableColumns = struct {
	...
	CommentLikeID: "comment_like.comment_like_id",
	CommentID:     "comment_like.comment_id",
	MemberID:      "comment_like.member_id",
	CreatedAt:     "comment_like.created_at",
	UpdatedAt:     "comment_like.updated_at",
	DeletedAt:     "comment_like.deleted_at",
}
...
var CommentLikeWhere = struct {
	...
	CommentLikeID: whereHelperint64{field: "`comment_like`.`comment_like_id`"},
	CommentID:     whereHelperint64{field: "`comment_like`.`comment_id`"},
	MemberID:      whereHelperint64{field: "`comment_like`.`member_id`"},
	CreatedAt:     whereHelpernull_Time{field: "`comment_like`.`created_at`"},
	UpdatedAt:     whereHelpernull_Time{field: "`comment_like`.`updated_at`"},
	DeletedAt:     whereHelpernull_Time{field: "`comment_like`.`deleted_at`"},
}
...
var (
	commentLikeAllColumns            = []string{"comment_like_id", "comment_id", "member_id", "created_at", "updated_at", "deleted_at"}
	commentLikeColumnsWithoutDefault = []string{"comment_id", "member_id", "deleted_at"}
	commentLikeColumnsWithDefault    = []string{"comment_like_id", "created_at", "updated_at"}
	commentLikePrimaryKeyColumns     = []string{"comment_like_id"}
...
func (q commentLikeQuery) One(ctx context.Context, exec boil.ContextExecutor) (*CommentLike, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mysql: failed to execute a one query for comment_like")
	}
...
func (q commentLikeQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to count comment_like rows")
	}
...
func (q commentLikeQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mysql: failed to check if comment_like exists")
	}
...
func CommentLikes(mods ...qm.QueryMod) commentLikeQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`comment_like`.*"})
	}
...
func FindCommentLike(ctx context.Context, exec boil.ContextExecutor, commentLikeID int64, selectCols ...string) (*CommentLike, error) {
	...
	query := fmt.Sprintf(
		"select %s from `comment_like` where `comment_like_id`=?", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mysql: unable to select from comment_like")
	}
...
func (o *CommentLike) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("mysql: no comment_like provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to insert into comment_like")
	}
	...
	if lastID != 0 && len(cache.retMapping) == 1 && cache.retMapping[0] == commentLikeMapping["comment_like_id"] {
		goto CacheNoHooks
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to populate default values for comment_like")
	}
...
func (o *CommentLike) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("mysql: unable to update comment_like, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update comment_like row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by update for comment_like")
	}
...
func (q commentLikeQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update all for comment_like")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to retrieve rows affected for comment_like")
	}
...
func (o *CommentLike) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("mysql: no comment_like provided for upsert")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to upsert for comment_like")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to retrieve unique values for comment_like")
	}
...
func (o *CommentLike) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM `comment_like` WHERE `comment_like_id`=?"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete from comment_like")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by delete for comment_like")
	}
...
func (q commentLikeQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete all from comment_like")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by deleteall for comment_like")
	}
...
func CommentLikeExists(ctx context.Context, exec boil.ContextExecutor, commentLikeID int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from `comment_like` where `comment_like_id`=? limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mysql: unable to check if comment_like exists")
	}
