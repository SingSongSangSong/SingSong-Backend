...
var (
	commentLikeAllColumns            = []string{"comment_like_id", "comment_id", "member_id"}
	commentLikeColumnsWithoutDefault = []string{"comment_id", "member_id"}
	commentLikeColumnsWithDefault    = []string{"comment_like_id"}
