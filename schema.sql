...
DROP TABLE IF EXISTS songReviewOption;
...
CREATE TABLE IF NOT EXISTS songReviewOption (
    songReviewOptionId BIGINT AUTO_INCREMENT PRIMARY KEY,
    title VARCHAR(100),
...
CREATE TABLE IF NOT EXISTS songReview (
    songReviewId BIGINT AUTO_INCREMENT PRIMARY KEY,
    songId BIGINT NOT NULL,
    memberId BIGINT NOT NULL,
    gender VARCHAR(20),
    birthyear INT,
    songReviewOptionId BIGINT NOT NULL,
    createdAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updatedAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deletedAt TIMESTAMP NULL DEFAULT NULL
);